...
TimeoutSerial::TimeoutSerial( unsigned int baud_rate,
...

{
	...
	open(baud_rate, opt_parity, opt_csize, opt_flow, opt_stop);

}



void TimeoutSerial::open(unsigned int baud_rate,
...

{
	...
	port.open("/dev/serial/by-id/usb-FTDI_UT232R_FT2D3911-if00-port0");
...

{
	...
	asio::deadline_timer timer(io, boost::posix_time::microseconds(2300));

	timer.wait();

	/*const bool isFlushed = !::PurgeComm(port.native_handle(),
...
/*http://mnb.ociweb.com/mnb/MiddlewareNewsBrief-201303.html#ref19
...

{
...

	{
		...
		//cout << "readdata :" << readData.size() << endl;
	...
	//cout << "readdata1 :" << readData.size() << endl;
